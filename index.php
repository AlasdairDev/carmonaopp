...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            <div class="navbar-brand">
                <a href="index.php">
                    <img src="./assets/carmona-logo.png" alt="City of Carmona Logo"
            ...
            <button class="menu-toggle" id="menuToggle" type="button"
                onclick="document.getElementById('navbarMenu').classList.toggle('show'); this.classList.toggle('active'); console.log('BURGER CLICKED!');">
                <span></span>
                <span></span>
                <span></span>
            </button>
    ...
    <section class="hero-section" id="home">
        <div class="hero-content">
            ...
            <div class="hero-text">
                ...
                <p>Permit & Document Request Tracking System<br>Track permits, submit documents, and stay updated on
                    your applications—all in one convenient platform for Carmona, Cavite residents.</p>
    ...
    <section class="mission-vision-section" id="mission-vision"
        style="background: linear-gradient(135deg, #a8d060 0%, #b5db70 15%, #c2e680 30%, #d0f090 50%, #ddf5a0 70%, #eafab0 85%, #f5fdc8 100%) !important; min-height: 100vh; display: flex; align-items: center;">
        <div class="mission-vision-container">
            <div class="mission-vision-text">
                <h2>Digital Governance for a Smarter City</h2>
                <p>The City of Carmona Portal was developed by the City's Information and Communications Technology
                    Department (ICTD) with a primary goal: to streamline bureaucratic processes and empower citizens and
                    businesses through digital efficiency.</p>
                <p>We are committed to transparency, speed, and public convenience.</p>
                <p>Since its launch in 2024, the platform has processed over 50,000 applications, cutting down average
                    processing time for key permits by 40%. Our infrastructure uses secure, modern encryption to protect
                    all your sensitive data and ensure compliance with national data privacy laws.</p>
            </div>
            ...
            <div class="mission-vision-cards">
                <div class="mv-card">
                    ...
                    <p>To provide a single, secure, and intuitive digital access point for all government services,
                        fostering a culture of transparency and efficiency in Carmona.</p>
                </div>
                ...
                <div class="mv-card">
                    ...
                    <p>To be the premier model for digital governance in the country, building a fully paperless,
                        smarter, and citizen-centric City of Carmona.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="footer-container">
            <div class="footer-content">
                <div class="footer-column">
                    <h3>About</h3>
                    <p>The City of Carmona Portal is your one-stop digital platform for all government permit and
                        document services, designed to make your life easier.</p>
                </div>
                ...
                <div class="footer-column">
                    ...
                    <p style="margin-top: 1rem;"><em>Closed on Weekend and Holidays</em></p>
                </div>
            </div>
            ...
            <div class="footer-bottom">
                ...
                <div class="footer-column">
                     <a href="https://carmonagov.net/portal/privacy-policy-2/" target="_blank" rel="noopener noreferrer">Privacy Policy</a>
                </div>
            </div>
        </div>
