        ...
        <div class="page-wrapper">
            <div class="container">
                ...
                <div class="stats-grid">
                    ...
                    <?php if ($stats['payment_required'] > 0): ?>
                    <div class="stat-card" style="border-left-color: #ffc107;">
                        <div class="stat-label">Payment Required</div>
                        <div class="stat-value" style="color: #ffc107;"><?php echo $stats['payment_required']; ?></div>
                    </div>
                    <?php endif; ?>
                </div>
                                ...
                                <div class="application-item">
                                    ...
                                    <div class="app-details">
                                        <div class="detail-item">
                                            ...
                                            <span class="detail-text"><?php echo htmlspecialchars($app['department_name']); ?></span>
                                        </div>
                                        <div class="detail-item">
                                            <span class="detail-icon">•</span>
                                            <span class="detail-text"><?php echo date('M d, Y', strtotime($app['created_at'])); ?></span>
                                        </div>
                                        <?php if ($app['payment_required']): ?>
                                        <div class="detail-item">
                                            <span class="detail-icon">₱</span>
