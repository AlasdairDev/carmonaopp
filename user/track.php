    ...
    <div class="page-wrapper">
        <div class="container">
            ...
            <div class="compact-card">
                <div style="background: linear-gradient(135deg, #7cb342 0%, #9ccc65 100%); margin: -2rem -2rem 1.5rem -2rem; padding: 1.5rem 2rem; border-radius: 20px 20px 0 0;">
            ...
            <?php if($tracking_number && $application): ?>
                ...
                <div class="compact-card">
                    ...
                    <div style="display: flex; align-items: center; gap: 1rem; padding: 1rem; border-radius: 12px; margin-bottom: 1.5rem; border-left: 4px solid; <?php
                        switch(strtolower($application['status'])) {
                            case 'pending': echo 'background: #fff3e0; border-color: #ef6c00;'; break;
                            case 'processing': echo 'background: #e3f2fd; border-color: #1976d2;'; break;
                            case 'approved': echo 'background: #e8f5e9; border-color: #2e7d32;'; break;
                            case 'rejected': echo 'background: #ffebee; border-color: #c62828;'; break;
                            case 'completed': echo 'background: #e8f5e9; border-color: #2e7d32;'; break;
                        }
                    ?>">
                        ...
                        <div>
                            <h3 style="margin: 0 0 0.25rem 0; font-size: 1.1rem; color: var(--text-dark); font-weight: 800; text-transform: uppercase;"><?php echo ucfirst($application['status']); ?></h3>
                            <p style="margin: 0; color: var(--text-light); font-size: 0.9rem;">
                                <?php
                                switch(strtolower($application['status'])) {
                                    case 'pending': echo 'Your application is waiting for review'; break;
                                    case 'processing': echo 'Your application is being processed'; break;
                                    case 'approved': echo 'Your application has been approved'; break;
                                    case 'rejected': echo 'Your application was not approved'; break;
                                    case 'completed': echo 'Your service is ready for release'; break;
                                }
                                ?>
                            </p>
                        </div>
                    ...
                    <div class="timeline">
                        <div class="timeline-item active">
                            ...
                            <div class="timeline-content">
                                ...
                                <span class="timeline-date"><?php echo formatDate($application['created_at']); ?></span>
                            </div>
                        </div>

                        <div class="timeline-item <?php echo (strtolower($application['status']) != 'pending') ? 'active' : ''; ?>">
                            <div class="timeline-marker"><?php echo (strtolower($application['status']) != 'pending') ? '✓' : ''; ?></div>
                            <div class="timeline-content">
                                <h4>Under Review</h4>
                                <p>Documents verification</p>
                                <?php if(strtolower($application['status']) != 'pending'): ?>
                                    <span class="timeline-date"><?php echo formatDate($application['updated_at']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>

                        <div class="timeline-item <?php echo (in_array(strtolower($application['status']), ['processing', 'approved', 'completed'])) ? 'active' : ''; ?>">
                            <div class="timeline-marker"><?php echo (in_array(strtolower($application['status']), ['processing', 'approved', 'completed'])) ? '✓' : ''; ?></div>
                            <div class="timeline-content">
                                <h4>Processing</h4>
                                <p>Application in progress</p>
                                <?php if(in_array(strtolower($application['status']), ['processing', 'approved', 'completed'])): ?>
                                    <span class="timeline-date"><?php echo formatDate($application['updated_at']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>

                        <div class="timeline-item <?php echo (in_array(strtolower($application['status']), ['approved', 'completed'])) ? 'active' : ''; ?>">
                            <div class="timeline-marker"><?php echo (in_array(strtolower($application['status']), ['approved', 'completed'])) ? '✓' : ''; ?></div>
                            <div class="timeline-content">
                                <h4><?php echo (strtolower($application['status']) == 'rejected') ? 'Rejected' : 'Approved'; ?></h4>
                                <p><?php echo (strtolower($application['status']) == 'rejected') ? 'Application not approved' : 'Ready for release'; ?></p>
                                <?php if(in_array(strtolower($application['status']), ['approved', 'completed', 'rejected'])): ?>
                                    <span class="timeline-date"><?php echo formatDate($application['updated_at']); ?></span>
                                <?php endif; ?>
                            </div>
                        </div>
                        ...
                        <div class="timeline-item <?php echo (strtolower($application['status']) == 'completed') ? 'active' : ''; ?>">
                            <div class="timeline-marker"><?php echo (strtolower($application['status']) == 'completed') ? '✓' : ''; ?></div>
                            <div class="timeline-content">
                                <h4>Completed</h4>
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <span style="font-family: monospace; color: var(--primary); font-weight: 800;"><?php echo htmlspecialchars($application['tracking_number']); ?></span>
                ...
                <div class="compact-card">
                    <div style="background: linear-gradient(135deg, #7cb342 0%, #9ccc65 100%); margin: -2rem -2rem 1.5rem -2rem; padding: 1.5rem 2rem; border-radius: 20px 20px 0 0;">
                        <h3 style="color: white; font-size: 1.1rem; margin: 0; font-weight: 700;">Processing Information</h3>
                    </div>
                    ...
                    <p class="form-text" style="margin-top: 0.5rem; font-size: 0.85rem;">Processing time is counted from the day your application is marked as "Processing"</p>
                </div>
                ...
                <div class="compact-card">
                    ...
                    <div style="padding: 0.75rem 0;">
                        ...
                        <span style="font-size: 0.95rem;"><?php echo htmlspecialchars($application['mobile_number']); ?></span>
                    </div>
                </div>
            ...
            <?php elseif($tracking_number): ?>
                ...
                <div class="alert alert-warning">
                    ...
                    <p style="margin: 0.5rem 0 0 0;">No application found with tracking number: <strong><?php echo htmlspecialchars($tracking_number); ?></strong></p>
                </div>
            <?php endif; ?>
            ...
            <div class="help-section-modern">
                <div class="help-title-box">
                    ...
                    <p class="help-subtitle">Our team is here for you</p>
                </div>
                ...
                <div class="help-content">
                    <div class="help-item">
                        ...
                        <div class="help-text">
                            <h4>Call Us</h4>
                            <span>(02) 8123-4567 • 0917-123-4567</span>
                        </div>
                    </div>
