...
function sendEmail($to, $subject, $body, $altBody = '') {
    ...
    if (!defined('SMTP_HOST') || !defined('SMTP_USERNAME') || !defined('SMTP_PASSWORD')) {
        ...
        logEmailStatus($to, $subject, 'failed', 'SMTP not configured');
        return false;
    }
    ...
    try {
        ...
        // Log success
        logEmailStatus($to, $subject, 'sent');
        ...
        logEmailStatus($to, $subject, 'failed', $errorMsg);
 ...
 */
function logEmailStatus($recipient, $subject, $status, $error = null) {
    global $pdo;
...
<body>
    <div class='container'>
        ...
        <div class='footer'>
            <p><strong>LGU Permit System</strong></p>
            <p>This is an automated message. Please do not reply to this email.</p>
            <p style='margin-top: 1rem; color: #999;'>© {$year} LGU Permit System. All rights reserved.</p>
        </div>
    </div>
</body>
</html>
